...
const Testimonials = ({ testimonials }) => {
  ...
  return (
    <div className="w-full px-5 md:px-10 py-10 bg-primary relative md:h-[88vh]">
          ...
          <Marquee pauseOnHover={true} autoFill={false} speed={100}>
            <div className="flex items-start gap-10">
              {leftReviews.map((review, index) => (
                <div
                  className={`w-full max-w-[600px] min-h-[300px] ${colors[index % colors.length]} p-6 rounded-lg flex items-center shadow-md mr-5`}
                  key={index}
                >
